...
class LLMConfigCache:
    ...
    def __init__(self, args):
        ...
        if args.llm_binding in ["openai", "azure_openai"]:
            from .llm.binding_options import OpenAILLMOptions
        ...
        if args.llm_binding == "gemini":
            from .llm.binding_options import GeminiLLMOptions
        ...
        if args.embedding_binding == "gemini":
            try:
                from .llm.binding_options import GeminiEmbeddingOptions
...
def create_app(args):
    ...
    def create_optimized_gemini_llm_func(
        ...
        async def optimized_gemini_model_complete(
            ...
            **kwargs,
            ...
            from .llm.gemini import gemini_complete_if_cache
    ...
    def create_optimized_embedding_function(
        ...
        try:
            if binding == "openai":
                ...
                from .llm.gemini import gemini_embed
                ...
                from .llm.azure_openai import azure_openai_embed
                ...
                from .llm.lollms import lollms_embed
    ...
    async def bedrock_model_complete(
        ...
        **kwargs,
        ...
        # Lazy import
        from .llm.bedrock import bedrock_complete_if_cache
    ...
    if args.rerank_binding != "null":
        from .rerank import cohere_rerank, jina_rerank, ali_rerank
