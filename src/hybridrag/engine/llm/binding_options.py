...
# in HybridRAG. It provides a standardized framework for:
#
...
class BindingOptions:
    ...
    def generate_dot_env_sample(cls):
        ...
        sample_top = (
            ...
            + "\n"
            + (
                "# Autogenerated .env entries list for HybridRAG binding options\n"
                "#\n"
                "# To generate run:\n"
                "# $ python -m hybridrag.engine.llm.binding_options\n"
            )
            + "#" * 80
            + "\n"
        )
        ...
        sample_bottom = (
            ("#\n# End of .env entries for HybridRAG binding options\n")
            + "#" * 80
            + "\n"
        )
...
#
# Usage:
#   python -m hybridrag.engine.llm.binding_options           # Generate .env sample
#   python -m hybridrag.engine.llm.binding_options test      # Test argument parsing
#
# =============================================================================
