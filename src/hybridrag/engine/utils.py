...
async def apply_rerank_if_enabled(
    ...
    Args:
        ...
        relevant_entity_ids: Set of entity IDs relevant to the query for entity boosting
    ...
    try:
        ...
        # Pass relevant_entity_ids for entity boosting if available
...
async def process_chunks_unified(
    ...
    relevant_entity_ids: set[str] | None = None,  # Entity IDs for entity boosting
) -> list[dict]:
    """
